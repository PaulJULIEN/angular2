...
export const JSONS: json[] = JSON.parse(JSON.stringify([
  { id: 1070, name: 'Super Mario World', 
  ...
  { id: 18061, "name": "Super Mario Bros. 3",
  ...
  { id: 23796, "name": "Candy Crush Soda Saga",
